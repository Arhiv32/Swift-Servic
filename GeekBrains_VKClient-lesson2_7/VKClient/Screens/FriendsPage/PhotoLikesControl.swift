...
//        NSLayoutConstraint(item: likesCount, attribute: NSLayoutConstraint.Attribute.trailing, relatedBy: NSLayoutConstraint.Relation.equal, toItem: self, attribute: NSLayoutConstraint.Attribute.trailing, multiplier: 1, constant: 1).isActive = true
        NSLayoutConstraint(item: likesCount, attribute: NSLayoutConstraint.Attribute.leading, relatedBy: NSLayoutConstraint.Relation.equal, toItem: likesImage, attribute: NSLayoutConstraint.Attribute.trailing, multiplier: 1, constant: 5).isActive = true
